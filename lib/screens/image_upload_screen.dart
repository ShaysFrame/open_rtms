...
//         print("📱 Image dimensions: ${_imageSize!.width}x${_imageSize!.height}");
//       }
//     } catch (e) {
...
//                             ),
//                           )
//                         : _imageSize != null ? Consumer<FaceDetectionProvider>(
//                             builder: (context, provider, child) {
//                               // Calculate actual available space
//                                       final availableWidth =
//                                           screenSize.width - 32;
//                                       final availableHeight = availableWidth *
//                                           3 /
//                                           4; // Fixed aspect ratio container

//                                       // Check if we have ML Kit faces detected
//                                       if (_mlKitFaces.isNotEmpty) {
//                                         print(
//                                             "📱 Rendering ${_mlKitFaces.length} ML Kit faces on image ${_imageSize!.width}x${_imageSize!.height}");
//                                         print("📱 UI Image available for rendering: ${_uiImage != null}");
                                        
//                                         return Stack(
//                                           children: [
//                                             // Display the ML Kit face detection results with the integrated image
//                                             CustomPaint(
//                                               size: Size(availableWidth,
//                                                   availableHeight),
//                                               painter: MLKitFacePainter(
//                                                 imageFile: _selectedImage,
//                                                 uiImage: _uiImage, // Pass the UI Image
//                                                 faces: _mlKitFaces,
...
//                                             // Add a label to indicate we're using ML Kit
//                                             Positioned(
//                                               top: 10,
//                                               right: 10,
//                                               child: Container(
...
//                                         // Fallback to the original overlay if no ML Kit faces
//                                         print(
